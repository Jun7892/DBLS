    ...
    <div className="fade-in pb-24">
      ...
      <div className="max-w-7xl mx-auto px-4 mt-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          <div className="p-8 md:p-10 border border-zinc-800 bg-zinc-900/30 rounded-sm space-y-4">
            <h4 className="text-xl font-bold flex items-center gap-2">
              <PackageCheck size={20} className="text-zinc-400" /> 소량 / 특수 운송 대응
            </h4>
            <div className="text-zinc-400 leading-loose">
              <p>상업용 대형 화물뿐 아니라</p>
              <p>소량 샘플, 개인 물품, 긴급 운송 건까지 유연하게 대응합니다.</p>
              <p>물동량 규모와 관계없이 최적의 프로세스를 적용합니다.</p>
            </div>
          </div>
          <div className="p-8 md:p-10 border border-zinc-800 bg-zinc-900/30 rounded-sm space-y-4">
            <h4 className="text-xl font-bold flex items-center gap-2">
            ...
            <div className="text-zinc-400 leading-loose">
              <p>통관 전 화물의 상태 보완을 위한 보수 작업,</p>
              <p>대량 화물의 소분(분할) 작업,</p>
              <p>보세 구역 간 이동 업무를 전문적으로 수행합니다.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-zinc-900/50 border border-zinc-800 p-8 md:p-12 rounded-sm">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-8 text-white">서비스 정책 가이드</h2>
              <div className="space-y-6 text-zinc-400 leading-relaxed text-lg font-light">
                <p>
                  당사는 <strong className="text-white font-medium">국내 구간 운송, 통관 실무, 부대 작업(보수·분할 등)</strong>을 핵심 업무로 수행합니다.
                </p>
                <p>
                  해외 운송 구간 및 해외 현지 통관은 지정 포워딩 업체 또는 화주 측과 협업하여 진행하며, 당사는 해당 운송의 원활한 국내 연결을 책임집니다.
                </p>
                <p className="bg-black/40 p-6 border-l-2 border-zinc-700">
                  원활한 업무 진행을 위해 <strong className="text-white font-medium">사전 협의 및 결제 확인 후 작업이 시작됩니다.</strong><br />
                  <span className="text-sm mt-2 block text-zinc-500">(견적 승인 후 배차 및 실무가 진행됩니다.)</span>
                </p>
              </div>
            </div>
          </div>
